...
public final class ActivityTournamentListBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityTournamentListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTournamentListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_tournament_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTournamentListBinding bind(@NonNull View rootView) {
